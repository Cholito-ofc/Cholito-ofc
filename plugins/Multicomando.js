const handler = async (msg, { conn }) => {
  ...
  const comando = text.trim().split(/\s+/)[0].replace(/^[.!/#]/, '').toLowerCase();

  const comandosValidos = [
    'puta', 'puto', 'peruano', 'peruana', 'negro', 'negra', 'manca', 'manco',
    'fea', 'feo', 'enano', 'enana', 'cachudo', 'cachuda', 'pajero', 'pajera',
